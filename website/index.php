...
<head>
  ...
  <style>
     body {
      ...
      margin: 0;
      background: url('image12.jpg') no-repeat center center fixed;
...
<section class="rooms" id="rooms">
  ...
  <div class="room-grid">
    <div class="room-card" tabindex="0" aria-label="Ocean View Suite. Enjoy a breathtaking view of the ocean with luxury amenities.">
      <img class="clickable-image" src="image.jpg" alt="Ocean View Suite" data-title="Ocean View Suite" data-description="Enjoy a breathtaking view of the ocean with luxury amenities." />
      <div class="room-content">
        <h4>Standard Room</h4>
        <p>Enjoy a breathtaking view of the ocean with luxury amenities.</p>
        <p><strong>Price: P5500 per night</strong></p>
      </div>
    </div>
    <div class="room-card" tabindex="0" aria-label="Mountain Cabin. Cozy and quiet, perfect for a nature retreat.">
      <img class="clickable-image" src="image1.jpg" alt="Mountain Cabin" data-title="Mountain Cabin" data-description="Cozy and quiet, perfect for a nature retreat." />
      <div class="room-content">
        <h4>Deluxe Room</h4>
        <p>Cozy and quiet, perfect for a nature retreat.</p>
        <p><strong>Price: P3000 per night</strong></p>
      </div>
    </div>
    <div class="room-card" tabindex="0" aria-label="Presidential Villa. Top-tier accommodation with private pool and butler service.">
      <img class="clickable-image" src="image2.jpg" alt="Presidential Villa" data-title="Presidential Villa" data-description="Top-tier accommodation with private pool and butler service." />
      <div class="room-content">
        <h4>Suite Room</h4>
        <p>Top-tier accommodation with private pool and butler service.</p>
        <p><strong>Price: P4500 per night</strong></p>
      </div>
    </div>
  </div>
</section>
...
<h3>Single Rooms</h3>
  <div class="room-grid">
    <div class="room-card" tabindex="0" aria-label="Ocean View Suite. Enjoy a breathtaking view of the ocean with luxury amenities.">
      <img class="clickable-image" src="image10.jpg" alt="Solo Room" data-title="Standard room" data-description="Enjoy a breathtaking view of the ocean with luxury amenities." />
      <div class="room-content">
        <h4>Standard Room Solo</h4>
        <p>Enjoy a breathtaking view of the ocean with luxury amenities.</p>
        <p><strong>Price: P3000 per night</strong></p>
      </div>
    </div>
    <div class="room-card" tabindex="0" aria-label="Mountain Cabin. Cozy and quiet, perfect for a nature retreat.">
      <img class="clickable-image" src="image9.jpg" alt="Mountain Cabin" data-title="Mountain Cabin" data-description="Cozy and quiet, perfect for a nature retreat." />
      <div class="room-content">
    ...
    <div class="room-card" tabindex="0" aria-label="Presidential Villa. Top-tier accommodation with private pool and butler service.">
      <img class="clickable-image" src="image8.jpg" alt="Presidential Villa" data-title="Presidential Villa" data-description="Top-tier accommodation with private pool and butler service." />
      <div class="room-content">
        <h4>Single Suite Room</h4>
        <p>Top-tier accommodation with private pool and butler service.</p>
        <p><strong>Price: P4500 per night</strong></p>
      </div>
    </div>
...
<section class="facilities" id="facilities">
  ...
  <div class="facility-grid">
    <div class="facility-card" tabindex="0" aria-label="Infinity Pool. Swim and relax with a view of the horizon.">
      <img class="clickable-image" src="image4.jpg" alt="Infinity Pool" data-title="Infinity Pool" data-description="Swim and relax with a view of the horizon." />
      <h4>Infinity Pool</h4>
    ...
    <div class="facility-card" tabindex="0" aria-label="Spa & Wellness. Unwind with professional spa treatments.">
      <img class="clickable-image" src="image5.jpg" alt="Spa & Wellness" data-title="Spa & Wellness" data-description="Unwind with professional spa treatments." />
      <h4>Spa & Wellness</h4>
    ...
    <div class="facility-card" tabindex="0" aria-label="Fine Dining. Enjoy world-class cuisine in a tropical setting.">
      <img class="clickable-image" src="image6.jpg" alt="Fine Dining" data-title="Fine Dining" data-description="Enjoy world-class cuisine in a tropical setting." />
      <h4>Fine Dining</h4>
    ...
    <div class="facility-card" tabindex="0" aria-label="Fitness Center. Stay fit with modern equipment and sea views.">
      <img class="clickable-image" src="images7.jpg" alt="Fitness Center" data-title="Fitness Center" data-description="Stay fit with modern equipment and sea views." />
...
<section class="booking-form" id="booking">
  ...
  <form action="submit_booking.php" method="POST" >
    ...
    <select name="room_type" required>
      ...
      <option value="Ocean View Suite">Standard Room</option>
      <option value="Mountain Cabin">Deluxe room</option>
      <option value="Presidential Villa">Suite Room</option>
      <option value="Ocean View Suite">Single Standard Room</option>
      <option value="Mountain Cabin">Single Deluxe room</option>
      <option value="Presidential Villa">Single Suite Room</option>
    </select>
...
<script>
  ...
  document.getElementById("bookingForm").addEventListener("submit", function (e) {
    ...
    fetch(`check_availability.php?room_type=${encodeURIComponent(roomType)}`)
      .then(response => response.json())
      .then(data => {
        if (data.available <= 0) {
          alert("Sorry, no available slots for the selected room.");
        } else {
          e.target.submit(); // proceed if available
        }
      })
      .catch(err => {
        console.error(err);
...
<footer class="footer">
  <div class="social-icons">
    <a href="https://web.facebook.com/pasaolbeachresort" target="_blank" title="Facebook">
